...
params = {'FyBSmax','FyBFmax','FyPSmax','FyPFmax', 'stepLengthFast', 'stepLengthSlow', 'netContributionNorm2', 'XSlow', 'XFast', 'alphaSlow', 'alphaFast'};%, 'SYZmag', 'FYZMag',  'FzFmax', 'FzSmax'};,  'FySBmaxQS','FySPmaxQS','FyFBmaxQS','FyFPmaxQS'
RF=getForceResults(YoungSlopeData,params,groups,0, 0, 0, 1);
