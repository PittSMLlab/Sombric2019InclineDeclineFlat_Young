...
%See also: labDate, strokeSubjectData
    ...
    methods
        ...
        function this=set.PythonScores(this,scores)
            if isa(scores,'PythonData') || isempty(scores)
                this.PythonScores=scores;
            else
                ME=MException('subjectData:Setter','PythonScores parameter is not object of the PythonData class');
                throw(ME);
            end
        end  
